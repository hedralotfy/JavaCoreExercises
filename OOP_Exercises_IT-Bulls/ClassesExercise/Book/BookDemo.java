...
public class BookDemo {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(bs.filterBooksByAuthor(new Author(1, "Jon", "Johnson"), books)));
		System.out.println();

		System.out.println(Arrays.toString(bs.filterBooksByPublisher(new Publisher(1, "Publisher_1"), books)));
		System.out.println();
		
		System.out.println(Arrays.toString(bs.filterBooksAfterSpecifiedYear(1992, books)));
	}
