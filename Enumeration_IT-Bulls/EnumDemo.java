...
//		priority2 = Priority.valueOf("high");	//java.lang.IllegalArgumentException
		...
		System.out.println("Priority.HIGH.ordinal() = " + Priority.HIGH.ordinal()); //0
		System.out.println("Priority.MEDIUM.ordinal() = " + Priority.MEDIUM.ordinal()); //1
		System.out.println("Priority.LOW.ordinal() = " + Priority.LOW.ordinal()); //2
